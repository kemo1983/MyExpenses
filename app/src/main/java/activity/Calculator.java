...
public class Calculator extends Fragment implements View.OnClickListener {
  ...
  Button btn0,btn1,btn3,btn4,btn5,btn6,btn7,btn8,btn2,btn9,btnadd,btnsub,btndiv,btnmult,btnclearall,btndot,btnequal,btndel,btnmode,btnparen;
    public Calculator() {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        btn0= (Button) getActivity().findViewById(R.id.button0);
        ...
        btn6= (Button) getActivity().findViewById(R.id.button6);
        btn7= (Button) getActivity().findViewById(R.id.button7);
        btn8= (Button) getActivity().findViewById(R.id.button8);
        btn9= (Button) getActivity().findViewById(R.id.button9);
        btnadd= (Button) getActivity().findViewById(R.id.buttonAdd);
        btnsub= (Button) getActivity().findViewById(R.id.buttonSub);
        btndiv= (Button) getActivity().findViewById(R.id.buttonDiv);
        btnmult= (Button) getActivity().findViewById(R.id.buttonMult);
        btnclearall= (Button) getActivity().findViewById(R.id.buttonAC);
        btndot= (Button) getActivity().findViewById(R.id.buttonDot);
        btnequal= (Button) getActivity().findViewById(R.id.buttonEqual);
        btndel= (Button) getActivity().findViewById(R.id.buttonDel);
        btnmode= (Button) getActivity().findViewById(R.id.buttonMode);
        btnparen= (Button) getActivity().findViewById(R.id.buttonParen);
    ...
    private void autoScrollTV() {
        final ScrollView sv = (ScrollView) getActivity().findViewById(R.id.resultScrollView);
